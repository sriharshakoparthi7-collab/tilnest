...
const ENV_ITEMS = [
  ...
  { label: "Fugitive Emissions & AC", path: "/environment/refrigerants", icon: Wind },
  { label: "Process Emissions", path: "/environment/process-emissions", icon: MoreHorizontal },
...
const NAV_ITEMS = [
  ...
  { label: "Equipment Registry", icon: Zap, path: "/equipment", type: "link" },
  {
